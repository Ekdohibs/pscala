...
\\ \par
Actuellement, l'implémentation du GC se limite à transformer les
informations de typage en informations de typage pour le GC (i.e, si
une expression est un entier, un pointeur où un paramètre de type)
dans \code{Is}. Il faudrait encore continuer à passer cette
information dans les langages suivants, produire les descripteurs de
\textit{stack frames}, et écrire le GC lui-même.
...
\item{Une suite d'instructions comme \code{mov \#{}1 \#{}2},~
    \code{mov \#{}1 \#{}3}, puis une utilisation des registres
    \code{\#{}2} et \code{\#{}3} cause les registres \code{\#{}2} et
    \code{\#{}3} comme étant déclarés comme interférant, et par
    conséquent les empêche d'obtenir le même registre.}
\end{itemize}
